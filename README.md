...
- **Fiches** — les **47 fiches de poche** SIHF / SEAF / IIHF (pénalités et codes, règles de
...
| `src/sheets.ts` | les 47 fiches de poche : numéro, thème, titre, contenu HTML, texte de recherche |
...
Les fiches de poche sont tirées des **cours de base SIHF — NWA ON01 « Règles générales » et
ON02 « Autres infractions »** — source de référence en cas de divergence —, du règlement de jeu
SEAF, des directives et aide-mémoires SIHF et du IIHF Official Rule Book 2026/27 ; elles reprennent la numérotation du
